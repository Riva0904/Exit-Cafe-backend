...
public class GetNewArrivalProductsQueryHandler : IRequestHandler<GetNewArrivalProductsQuery, List<ProductListItemDto>>
{
    private readonly IUnitOfWork _uow;
    private readonly IMapper _mapper;

    public GetNewArrivalProductsQueryHandler(IUnitOfWork uow, IMapper mapper)
    {
        _uow = uow;
        _mapper = mapper;
    }
    ...
    public async Task<List<ProductListItemDto>> Handle(GetNewArrivalProductsQuery request, CancellationToken ct) =>
